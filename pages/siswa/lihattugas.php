...
?>
            <ul class="sidebar-body-menu">
              <li>
                ...
                <li>
                    <a  class="active" href="lihattugas.php"><span class="icon document" aria-hidden="true"></span>Lihat Hasil Tugas</a>
                </li>
            </ul>
        </div>
...
if ($role === 'guru') {
    ...
    $query = "SELECT tugas.id_tugas, tugas.judul, tugas.deskripsi, 
          ...
          AND pengumpulan_tugas.id_user = '$user_id'";
}
...
<br>
<h2 class="main-title">Daftar tugas yang sudah diupload</h2>
<br>
<div class="users-table table-wrapper">
    <table class="posts-table">
        ...
        <tbody>
                        ...
                        <td>
                            <span class="p-relative">
                                ...
                                <ul class="users-item-dropdown dropdown">
                                    <li><a href="lihatnilai.php?id_tugas=<?php echo $row['id_tugas']; ?>">Lihat Penilaian</a></li>
                                </ul>
                            </span>
                        </td>
                    </tr>
            ...
            <?php else: ?>
                <tr>
                    <td colspan="5" style="text-align: center;">Belum ada tugas yang di-upload.</td>
                </tr>
            <?php endif; ?>
        </tbody>
    </table>
