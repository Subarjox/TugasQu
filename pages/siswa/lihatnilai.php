        ...
        <div class="sidebar-head">
            <a href="/" class="logo-wrapper" title="Home">
                ...
                <div class="logo-text">
                    ...
                    <span class="logo-subtitle">siswa</span>
                </div>
...
<?php
// Misalnya kita sudah mendapatkan id_tugas
$id_tugas = $_GET['id_tugas']; // Atau bisa dari post jika diperlukan

// Query untuk mengambil data tugas beserta nilai dan komentar
$query = "SELECT tugas.judul, tugas.deskripsi, pengumpulan_tugas.nilai, pengumpulan_tugas.komentar, pengumpulan_tugas.file_tugas
          FROM tugas
    ...
    <main class="main users chart-page" id="skip-target">
        <div class="container">
            <article class="sign-up">
                ...
                <form class="sign-up-form form" action="../../classes/uploadtugas.php" method="POST" enctype="multipart/form-data">
                    ...
                    <label class="form-label-wrapper">
                        ...
                        <input class="form-input" type="text" name="nilai" value="<?php echo $nilai; ?>" readonly>
                    </label>

                    <!-- Komentar dengan placeholder jika kosong -->
                    <label class="form-label-wrapper">
                        <p class="stat-cards-info__title">Komentar</p>
                        <input class="form-input" type="text" name="komentar" value="<?php echo $komentar; ?>" readonly>
                    </label>

                    <!-- Input File untuk Upload File PDF (hanya jika file sudah ada) -->
                    <label class="form-label-wrapper">
                        <p class="stat-cards-info__title">File Anda : </p>
                        <br>
                        <p> <a href="uploads/pdf-tugas/<?php echo htmlspecialchars($row['file_tugas']); ?>" target="_blank"> ⬇️ Download</a> </P>
                    </label>
