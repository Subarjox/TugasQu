    ...
    <main class="main users chart-page" id="skip-target">
        <div class="container">
            <article class="sign-up">
                <h2 class="main-title">Upload Tugas </h2>
                <form class="sign-up-form form" action="../../classes/uploadtugas.php" method="POST" enctype="multipart/form-data">
                    ...
                    <!-- Input File untuk Upload File PDF -->
                    <label class="form-label-wrapper">
                        <p class="stat-cards-info__title">Upload File PDF</p>
                        <input class="form-input" type="file" name="file_tugas" accept="application/pdf" required>
                    </label>

                    <button class="form-btn primary-default-btn transparent-btn">Upload Tugas</button>
                    <br>  
                </form>
            </article>
        </div>
