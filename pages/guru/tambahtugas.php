...
<ul class="sidebar-body-menu">
              <li>
                ...
                <li>
                    <a class="active" href="tambahtugas.php"><span class="icon folder" aria-hidden="true"></span>Tambah Tugas</a>
                </li>
                <li>
...
<div class="container">
  ...
  <h2 class="main-title">Tambah Tugas</h1>
    <form class="sign-up-form form" action="../../classes/tambahtugas.php" method="POST">
      <label class="form-label-wrapper">
        <p class="stat-cards-info__title">Judul Tugas</p>
        <input class="form-input" type="text" name="judul" placeholder="Masukan Judul Tugas " required>
      </label>
      <label class="form-label-wrapper">
        <p class="stat-cards-info__title">Deskripsi Singkat</p>
        <input class="form-input" type="text" name="deskripsi" placeholder="Masukan Deskripsi Tugas" required>
      </label>
      <label class="form-label-wrapper">
        <p class="stat-cards-info__title">Batas Waktu</p>
        <input class="form-input" type="date" name="batas_waktu" placeholder="Masukan Batas Waktu" required>
      </label>
      <label class="form-checkbox">
        <p class="stat-cards-info__title">Status</p>
        <div>
          <label>
            <input class="form-input" type="radio" name="status" value="aktif" required>  
            Aktif
          </label>
        </div>
        <div>
          <label>
            <input class="form-input" type="radio" name="status" value="nonaktif" required>
            Nonaktif
          </label>
        </div>
      </label>
      <button class="form-btn primary-default-btn transparent-btn"> + Tambah Tugas</button>
    </form>
  </article>
  </div>
</main>
