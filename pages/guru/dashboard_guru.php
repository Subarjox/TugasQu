...
?>
            <ul class="sidebar-body-menu">
              <li>
                ...
                <li>
                    <a class="active" href="dashboard_guru.php"><span class="icon home" aria-hidden="true"></span>Dashboard</a>
                </li>
                <li>
        ...
        <article class="stat-cards-item">
          ...
          <div class="stat-cards-info">
            <p class="stat-cards-info__num">
              ...
              $queryTotalTugas = "SELECT COUNT(*) AS total FROM tugas WHERE id_user = '$user_id'";
            ...
            <p class="stat-cards-info__title">Total tugas yang anda buat</p>
        ...
        <article class="stat-cards-item">
          ...
          <div class="stat-cards-info">
            <p class="stat-cards-info__num">
              ...
              $queryTotalSiswa = "SELECT COUNT(*) AS total FROM users WHERE role = 'siswa'";
        ...
        <article class="stat-cards-item">
          ...
          <div class="stat-cards-info">
            <p class="stat-cards-info__num">
              ...
              $queryTugasAktif = "SELECT COUNT(*) AS total FROM tugas WHERE status = 'Aktif' AND id_user = '$user_id'";
              $resultTugasAktif = mysqli_query($koneksi, $queryTugasAktif);
              $totalTugasAktif = $resultTugasAktif ? mysqli_fetch_assoc($resultTugasAktif)['total'] : 0;
              echo $totalTugasAktif;
              ?>
            </p>
            <p class="stat-cards-info__title">Total tugas aktif yang anda buat</p>
            <p class="stat-cards-info__progress">
            </p>
          </div>
        </article>
...
if ($role === 'guru') {
    ...
    // Siswa bisa melihat semua tugas
...
<div class="users-table table-wrapper">
                        ...
                        <td>
                            <span class="p-relative">
                                ...
                                <ul class="users-item-dropdown dropdown">
                                    <li><a href="edittugas.php?id_tugas=<?php echo $row['id_tugas']; ?>">Edit</a></li>
                                </ul>
                            </span>
                        </td> 
                    </tr>
    ...
    <a href="tambahtugas.php"> <button class="form-btn primary-default-btn transparent-btn">+ Tambah Tugas </button></a>
    </div>
</div>
